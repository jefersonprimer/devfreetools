  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#DC5A5A]/5 dark:bg-[#DC5A5A]/10 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-foreground/5 dark:bg-foreground/5 rounded-full blur-[120px] animate-pulse [animation-delay:1s]" />
      </div>
      ...
      <div className="relative w-full max-w-md mx-4">
        ...
        <div className="bg-card backdrop-blur-xl border border-border/50 rounded-[2.5rem] p-10 shadow-2xl shadow-foreground/5">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground mt-2 text-sm font-medium">Entre na sua conta para continuar</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-muted-foreground text-sm font-medium">
              Ainda não tem conta?{' '}
              <a href="/signup" className="text-[#DC5A5A] hover:opacity-80 font-bold transition-all decoration-[#DC5A5A]/30 decoration-2 underline-offset-4 hover:underline">
                Criar conta grátis
              </a>
            </p>
          </div>
