  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-purple-600/10 dark:bg-purple-600/20 rounded-full blur-[120px] animate-pulse [animation-delay:1s]" />
        <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-indigo-600/10 dark:bg-indigo-600/15 rounded-full blur-[100px] animate-pulse [animation-delay:2s]" />
      </div>
      ...
      <div className="relative w-full max-w-md mx-4">
        ...
        <div className="bg-card backdrop-blur-xl border border-border rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2 text-sm">Entre na sua conta para acessar o dashboard</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-muted-foreground text-sm">
              Não tem conta?{' '}
              <a href="/signup" className="text-primary hover:opacity-80 font-semibold transition-colors">
                Criar conta grátis
              </a>
            </p>
          </div>
