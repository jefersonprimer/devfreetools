  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-purple-600/20 rounded-full blur-[120px] animate-pulse [animation-delay:1s]" />
        <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-indigo-600/15 rounded-full blur-[100px] animate-pulse [animation-delay:2s]" />
      </div>
      ...
      <div className="relative w-full max-w-md mx-4">
        ...
        <div className="bg-white/[0.04] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-8 shadow-2xl shadow-black/40">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2 text-sm">Entre na sua conta para acessar o dashboard</p>
          </div>
