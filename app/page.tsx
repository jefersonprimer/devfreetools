...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="#tools" className="text-sm font-semibold text-gray-500 hover:text-blue-600 transition-colors">Ferramentas</a>
              <a href="#api" className="text-sm font-semibold text-gray-500 hover:text-blue-600 transition-colors">API</a>
              <a href="#pricing" className="text-sm font-semibold text-gray-500 hover:text-blue-600 transition-colors">Preços</a>
              {!loading && (
                user ? (
                  <a href="/dashboard" className="text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-2 rounded-lg hover:from-blue-500 hover:to-purple-500 transition-all shadow-lg shadow-blue-500/20">Dashboard</a>
                ) : (
                  <>
                    <a href="/login" className="text-sm font-semibold text-gray-600 hover:text-gray-900 transition-colors">Login</a>
      ...
      {/* Tools Section */}
      <section id="tools" className="py-24 bg-gray-50/50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="group p-8 rounded-3xl hover:bg-gray-50 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 tracking-tight">Developer-First</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      {/* API Section */}
      <section id="api" className="py-24 bg-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-3xl p-2 border border-white/5 shadow-2xl">
      ...
      <section id="pricing" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white border border-gray-200 rounded-3xl p-8 text-center hover:shadow-xl transition-shadow">
              <h3 className="text-2xl font-bold text-gray-900 mb-4 tracking-tight">Free</h3>
              <div className="text-4xl font-black text-gray-900 mb-2">R$ 0</div>
              <p className="text-gray-500 mb-6 font-medium">Por mês</p>
              <ul className="text-left space-y-4 mb-8">
                {['100 consultas/mês', 'Cache inteligente', 'API REST'].map((item) => (
                  <li key={item} className="flex items-center text-sm font-semibold text-gray-600">
              ...
              <button className="w-full bg-gray-100 text-gray-900 py-3 px-4 rounded-xl font-bold hover:bg-gray-200 transition-colors">
                Começar Grátis
              </button>
            </div>

            <div className="bg-gray-900 text-white rounded-3xl p-8 text-center relative shadow-2xl scale-105 z-10">
            ...
            <div className="bg-white border border-gray-200 rounded-3xl p-8 text-center hover:shadow-xl transition-shadow">
              <h3 className="text-2xl font-bold text-gray-900 mb-4 tracking-tight">Pro</h3>
              <div className="text-4xl font-black text-gray-900 mb-2">R$ 79,90</div>
              <p className="text-gray-500 mb-6 font-medium">Por mês</p>
              <ul className="text-left space-y-4 mb-8">
      ...
      <footer className="bg-gray-50 border-t border-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <h4 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-6">Suporte</h4>
              <ul className="space-y-4 text-sm font-semibold text-gray-500">
